    ...
    _presetSequenceElements(this), color_mgr(this)
{
    ...
    FPPConnect = new wxButton(Panel5, ID_BUTTON12, _("FPP Connect"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_BUTTON12"));
    FPPConnect->SetDefault();
    FlexGridSizerSetupControllerButtons->Add(FPPConnect, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
    ...
    Button_OpenProxy = new wxButton(Panel5, ID_BUTTON14, _("Open Proxy"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_BUTTON14"));
    ...
    Connect(ID_BUTTON14,wxEVT_COMMAND_BUTTON_CLICKED,(wxObjectEventFunction)&xLightsFrame::OnButton_OpenProxyClick);
